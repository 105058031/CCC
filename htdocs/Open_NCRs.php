...
$jsonData=array();
    ...
    die('  '. print_r($db->errorInfo()));
                ...
                {
                                 $jsonData[] = array('Pending_Stage'=>$row['Pending Stage'],
								 'Part_2'=>$row['Part# 2'],'Cell'=>$row['Cell'],'Logged_Date_2'=>$row['Logged Date 2'],'NCR'=>$row['NCR#'],'Owner_Inits'=>$row['Owner Inits']);
